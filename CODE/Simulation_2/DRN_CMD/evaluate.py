...
model = model_from_json(open(u'drn_model_architecture.json').read())
model.load_weights(u'drn_model_weights.h5')
...
for N in range(15):
    ...
    for o in range(4):
        ...
        map[16:144, 16:144, 0:nb_energy] = X[N,:,:,o*5:(o+1)*5]
...
sio.savemat(u'drn_result.mat', {'Y_label':ans1,'Y_pred':ans2})
